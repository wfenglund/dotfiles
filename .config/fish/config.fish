...
alias untar="tar -xvf"
alias lah="ls -lah"
alias nocaps="source ~/dotfiles/bash_scripts/remap_keys.sh" # Change caps lock into less and greater and insert to bar, if caps get stuck activated, run 'onboard' and deactivate
...
alias wikiwfish="python ~/dotfiles/config_scripts/wikiw.py ~/dotfiles/config_scripts/wikiwfish.txt"
...
alias 1screenhome="xrandr --output eDP-1 --mode 1920x1080 --pos 0x0 --rotate normal --output HDMI-1 --off --output DP-1 --off --output HDMI-2 --off --output DP-1-0 --off --output DP-1-1 --off --output DP-1-2 --off --output DP-1-3 --off"
...
alias 2workscreenhome="xrandr --output eDP --mode 2240x1400 --pos 2560x40 --rotate normal --output HDMI-A-0 --mode 2560x1440 --pos 0x0 --rotate normal --output DisplayPort-0 --off --output DisplayPort-1 --off --output DisplayPort-2 --off --output DisplayPort-3 --off"
alias 1workscreenhome="xrandr --output eDP --mode 2240x1400 --pos 0x0 --rotate normal --output HDMI-A-0 --off --output DisplayPort-0 --off --output DisplayPort-1 --off --output DisplayPort-2 --off --output DisplayPort-3 --off"
